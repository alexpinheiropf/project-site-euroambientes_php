...
<meta charset="utf-8">
	...
	if (array_search ( $extensao, $_UP ['extensoes'] ) === false) {
		...
		$query = mysqli_query ($conectar, "INSERT INTO imagem_pagina (
		...
		<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/euroambientes.com.br/adm/administrativo.php?link=19&id=$pagina_id'>
